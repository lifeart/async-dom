...
var VirtualTextNode = class VirtualTextNode {
	...
	cloneNode(_deep) {
		return new VirtualTextNode(this._nodeValue, require_sync_channel.createNodeId(), this.collector);
	}
};
/**
...
var VirtualCommentNode = class VirtualCommentNode {
	...
	cloneNode(_deep) {
		return new VirtualCommentNode(this._nodeValue, require_sync_channel.createNodeId(), this.collector);
	}
};
